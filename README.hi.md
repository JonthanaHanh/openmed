...
<p>
  <b>2,000+ मॉडल</b> &nbsp;·&nbsp; <b>17 मॉडल-समर्थित PII भाषाएँ</b> &nbsp;·&nbsp; <b>600+ PII चेकपॉइंट</b> &nbsp;·&nbsp; <b>100% डिवाइस पर</b> &nbsp;·&nbsp; <b>Apache-2.0</b>
</p>
...
| मॉडल-समर्थित PII भाषाएँ               |            17            |            भिन्न            |
| ऑफ़लाइन / एयर-गैप्ड                   |            ✅            |             ❌              |
...
## बहुभाषी PII (17 मॉडल-समर्थित भाषाएँ)

निष्कर्षण और डी-आइडेंटिफिकेशन **17 समर्थित PII भाषा codes** में उपलब्ध हैं:
`ar`, `de`, `en`, `es`, `fr`, `he`, `hi`, `id`, `it`, `ja`, `ko`, `nl`, `pt`, `ro`, `te`, `th` और `tr`, कुल **600+ PII checkpoints** के साथ।
ये मॉडल-समर्थित PII भाषाओं की allow-list हैं।
OpenMed में Polish, Latvian, Slovak, Malay, Filipino और Danish जैसे अतिरिक्त ID-only locales के लिए validator-समर्थित national-ID coverage भी शामिल है।
...
| [सुरक्षा नीति](SECURITY.md) | [Compliance posture](docs/compliance.md) | |
...
<a href="https://star-history.com/#maziyarpanahi/openmed&Date">
  <img src="https://api.star-history.com/svg?repos=maziyarpanahi/openmed&type=Date" alt="स्टार इतिहास चार्ट" width="640" />
</a>
