...
PII extraction and de-identification support **18 supported PII language codes**:
`am`, `ar`, `de`, `en`, `es`, `fr`, `he`, `hi`, `id`, `it`, `ja`, `ko`, `nl`, `pt`, `ro`, `te`, `th`, and `tr`.
...
[Multilingual PII](https://github.com/maziyarpanahi/openmed#multilingual-pii-18-model-backed-languages).
