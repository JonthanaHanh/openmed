...
PII extraction and de-identification support **19 supported PII language codes**:
`ar`, `de`, `en`, `es`, `fr`, `he`, `hi`, `id`, `it`, `ja`, `ko`, `nl`, `pt`, `ro`, `te`, `th`, `tr`, `xh`, and `zu`.
...
[Multilingual PII](https://github.com/maziyarpanahi/openmed#multilingual-pii-19-model-backed-languages).
