...
The mappings are conservative engineering controls informed by the following
primary legal texts:
...
- Kenya's [Data Protection Act 2019](https://new.kenyalaw.org/akn/ke/act/2019/24/eng%402019-11-15), section 2, treats economic identity as potentially identifying and includes property details among sensitive personal data. A mobile-wallet transaction or account reference is therefore handled conservatively as an account identifier rather than as ordinary prose.
- Egypt's [Personal Data Protection Law No. 151 of 2020](https://manshurat.org/node/66932) defines financial data as sensitive personal data. Mobile-money account and transaction references use the existing `ACCOUNT_NUMBER` canonical label.
