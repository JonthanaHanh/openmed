...
sets cross-border transfer conditions in Articles 18-21. Article 22 includes
local-server provisions for categories designated by regulation and requires
prior Authority approval for cross-border transfer of sensitive personal data;
the definition of sensitive data includes health information. The attestation
can support a finding that a particular de-identification run stayed host-local,
but it is not Authority approval.
...
[Kenya's Data Protection Act No. 24 of 2019](https://new.kenyalaw.org/akn/ke/act/2019/24/eng@2019-11-15)
...
data center in Kenya. Host-local operation is useful evidence, but the
organization must still determine whether a transfer occurs and which category
