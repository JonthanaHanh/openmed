...
|---|---:|---|
| Exact-span F1 | {{ benchmark.metrics.exact_span_f1 }} | {{ benchmark.suite }}; {{ benchmark.generated_at }} |
| Character recall | {{ benchmark.metrics.character_recall }} | {{ benchmark.fixture_count }} fixtures; {{ benchmark.device }} |
...
| Character leakage | {{ benchmark.metrics.leakage }} | [Overall, critical labels, and confidence interval] |
