...
| Character leakage | `BenchmarkReport.metrics.leakage` | [Overall and critical-label results] |
| Span accuracy | `BenchmarkReport.metrics.exact_span_f1` and `relaxed_span_f1` | [Values] |
