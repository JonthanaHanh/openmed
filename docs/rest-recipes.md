...
selects the recommended PII model for `lang`. The 26 supported PII language
codes: `ar`, `as`, `bn`, `de`, `en`, `es`, `fr`, `gu`, `he`, `hi`, `id`, `it`,
`ja`, `kn`, `ko`, `ml`, `mr`, `nl`, `or`, `pa`, `pt`, `ro`, `ta`, `te`, `th`,
and `tr`. The 11 Indic languages use `OPENMED_INDIC_NER_MODEL` when explicitly
configured; `confidence_threshold` defaults to `0.5`.
