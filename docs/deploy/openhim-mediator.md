...
The management credentials authorize mediator registration and heartbeat, so keep them out of `mediator-config.json`, source control, images, and logs.
...
curl --request POST http://openhim-core.internal:5001/openmed/deidentify \
...
The fixture uses synthetic credentials and payloads. Never use it as an HIE component.
