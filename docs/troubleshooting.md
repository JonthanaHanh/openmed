...
**Cause.** PII extraction and de-identification support **20 supported PII language codes: ar, da, de, en,
es, fr, he, hi, id, it, ja, ko, nl, no, pt, ro, sv, te, th, and tr**. Passing anything outside that set (or a mistyped
