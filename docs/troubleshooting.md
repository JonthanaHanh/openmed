...
```text
ValueError: Unsupported language 'xx'. Supported: ['ar', 'de', 'en', 'es', 'fr', 'he', 'hi', 'id', 'it', 'ja', 'ko', 'nl', 'pt', 'ro', 'te', 'th', 'tr', 'xh', 'zu']
```

**Cause.** PII extraction and de-identification support **19 supported PII language codes: ar, de, en, es,
fr, he, hi, id, it, ja, ko, nl, pt, ro, te, th, tr, xh, and zu**. Passing anything outside that set (or a mistyped
