...
def build_models_size_report(
    ...
    *,
    ...
    for estimate in estimates:
        ...
        if cached is not None and cached.size_on_disk > 0:
        ...
        download_mb = 0.0 if cached is not None else snapshot_mb
        ...
        rows.append(
            {
                ...
                "status": (
                    "cached — 0 MB to download" if cached is not None else "not cached"
                ),
                "source": source,
                "recommended": False,
            }
