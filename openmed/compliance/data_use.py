...
DEFAULT_DENIED_ACTIONS: Mapping[DataUseTag, frozenset[DataUseAction]] = {
    ...
    DataUseTag.NO_EXPORT: frozenset({DataUseAction.EXPORT, DataUseAction.FHIR_EXPORT}),
...
class DataUsePolicy:
    ...
    ] = field(default_factory=lambda: dict(DEFAULT_DENIED_ACTIONS))
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(self, "denied_actions", normalized)
