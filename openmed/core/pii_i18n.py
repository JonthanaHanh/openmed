...
def get_patterns_for_language(lang: str, locale: str | None = None) -> List[PIIPattern]:
    ...
    # English patterns serve as universal base. MRZ and Aadhaar patterns are
    # language-agnostic, so they join the universal base for every route.
    base = list(PII_PATTERNS) + MRZ_PII_PATTERNS + AADHAAR_PII_PATTERNS
