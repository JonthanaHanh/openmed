...
SCRIPT_LANGUAGE_HINTS: dict[str, tuple[str, ...]] = {
    "Latin": ("en", "fr", "de", "it", "es", "nl", "pt", "tr", "ig"),
    "Arabic": ("ar",),
    "Han": ("ja",),
...
def snap_span_to_grapheme_boundaries(
    ...
    De-identification must not leave a tone or dot-below mark orphaned when a
    model returns offsets inside a decomposed grapheme. This targets the
    base-plus-mark boundary needed for safe replacement without adding a full
    text-segmentation dependency.
    """
