...
# स्थानीय नियम नमूने के हर पहचानकर्ता को निश्चित रूप से पहचानते हैं।
# Local rules deterministically cover every identifier embedded in the samples.
INDIA_CUSTOM_RECOGNIZER = {
    ...
    "deny": {
        "terms": [
            ...
            {"term": SYNTHETIC_AADHAAR, "label": "ID_NUM"},
            {"term": SYNTHETIC_ABHA, "label": "ID_NUM"},
...
def assert_synthetic_identifiers_removed(
    ...
    assert not leaked, f"Synthetic identifiers survived in {note_name}: {leaked!r}"
