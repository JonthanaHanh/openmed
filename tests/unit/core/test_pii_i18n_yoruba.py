...
FIXTURE_PATH = Path("openmed/eval/golden/fixtures/i18n/yo.jsonl")
...
@pytest.mark.parametrize(
    ("marked_context", "value", "entity_type", "minimum_confidence"),
    (
        ("nọ́mbà ìdánimọ̀ NIN", "12345678901", "national_id", 0.95),
        ("nọ́ńbà tẹlifóònù", "+234 803 123 4567", "phone_number", 0.9),
    ),
)
...
def test_tone_marked_decomposed_and_unmarked_contexts_trigger_patterns(
    ...
    matches = [
        ...
        if entity.text == value and entity.label == entity_type
    ]
